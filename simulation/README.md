...
> `mjpython simulation/mujoco_viewer.py --tool gripper --passive`. The embedded
> viewer and the headless modes run under plain `python`. Over remote desktop /
> VNC the embedded (offscreen) viewer is usually the more reliable choice.
